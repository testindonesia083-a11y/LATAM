          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto items-center">
            ...
            <FadeIn delay={0.1}>
              <div className="bg-[#111111] rounded-3xl p-10 relative transform md:-translate-y-4 shadow-[0_0_50px_-12px_rgba(201,162,39,0.3)]">
                ...
                <a href="https://pay.hotmart.com/U106546551D?off=pjja75vs" target="_blank" rel="noopener noreferrer" className="animate-bounce block w-full h-16 text-lg font-bold bg-[#c9a227] hover:bg-[#a8831c] text-black mb-4 rounded-xl shadow-[0_0_30px_-5px_rgba(201,162,39,0.4)] active:scale-95 flex items-center justify-center">
                  {currT.planFullBtn}
                </a>
